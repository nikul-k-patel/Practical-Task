...
//
// import '../screens/auth/login/model/loginResponseModel.dart';
//
...
// }
//
// Future<bool> saveLoginDataToSP(LoginResponseModel loginResponse) async {
//   final sp = await SharedPreferences.getInstance();
//   return sp.setString("loginModelKey", jsonEncode(loginResponse.toJson()));
// }
//
// //
// Future<LoginResponseModel?> getLoginDataFromSP() async {
//   final sp = await SharedPreferences.getInstance();
//   final user = sp.getString("loginModelKey");
//   if (user == null) {
//     return null;
//   }
//   return LoginResponseModel.fromJson(jsonDecode(user));
// }
