class MainCategoryResponse {
  ...
  MainCategoryResponse({this.status, this.message, this.result});
  ...
  Result.fromJson(Map<String, dynamic> json) {
    if (json['Category'] != null) {
      ...
      json['Category'].forEach((v) {
        category!.add(new CategoryMain.fromJson(v));
      });
    }
  }
...
class CategoryMain {
  ...
  CategoryMain.fromJson(Map<String, dynamic> json) {
    id = json['Id'];
    name = json['Name'];
